document.addEventListener("DOMContentLoaded", function () {
  ...
  let camposEliminados =
    JSON.parse(localStorage.getItem("camposEliminados")) || [];
  ...
  if (
    ...
    !produtoAtual.camposRemovidos.includes("titulo")
  ) {
    if (produtoAtual.titulo)
      document.getElementById("inputTitulo").value = produtoAtual.titulo;
  } else {
  ...
  if (
    !produtoAtual.camposRemovidos ||
    !produtoAtual.camposRemovidos.includes("descricao")
  ) {
    if (produtoAtual.descricao)
      document.getElementById("inputDescricao").value = produtoAtual.descricao;
  } else {
  ...
  if (
    !produtoAtual.camposRemovidos ||
    !produtoAtual.camposRemovidos.includes("categoria")
  ) {
    if (produtoAtual.categoria)
      document.getElementById("inputCategoria").value = produtoAtual.categoria;
  } else {
  ...
  if (
    !produtoAtual.camposRemovidos ||
    !produtoAtual.camposRemovidos.includes("tamanho")
  ) {
    if (produtoAtual.tamanho)
      document.getElementById("inputTamanho").value = produtoAtual.tamanho;
  } else {
  ...
  if (
    !produtoAtual.camposRemovidos ||
    !produtoAtual.camposRemovidos.includes("preco")
  ) {
    if (produtoAtual.preco)
      document.getElementById("inputPreco").value = produtoAtual.preco;
  } else {
  ...
  if (
    !produtoAtual.camposRemovidos ||
    !produtoAtual.camposRemovidos.includes("localizacao")
  ) {
    if (produtoAtual.localizacao)
...
function adicionarInfoExtra() {
  ...
  if (!novaInfo) {
    document.getElementById("mensagem_informacao_adicionada").innerHTML =
